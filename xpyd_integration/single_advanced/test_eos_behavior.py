...
def app():
    ...
    config = ServerConfig(prefill_delay_ms=0, decode_delay_per_token_ms=0, eos_min_ratio=0.5)
...
async def test_eos_min_ratio_respected():
    ...
    config = ServerConfig(prefill_delay_ms=0, decode_delay_per_token_ms=0, eos_min_ratio=0.8)
